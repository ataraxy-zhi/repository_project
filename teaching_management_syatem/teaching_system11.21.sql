...
CREATE TABLE `student` (
  ...
  `stu_cridit` double(4,1) DEFAULT '0.0',
  PRIMARY KEY (`stu_id`),
...
INSERT INTO `begin_course` VALUES ('0001','0001','020001','0001',120,'第一周','第八周','周一1-2，周四3-4');
...
CREATE TABLE `select_course` (
  ...
  `sc_grade` double(4,1) DEFAULT NULL,
  PRIMARY KEY (`sc_id`),
...
INSERT INTO `select_course` VALUES ('0001','0001','030001','2019-2020-1',NULL);
...
INSERT INTO `user` VALUES ('010001','bob','123','administrator'),('020001','mike','123456','teacher'),('020002','mary','654321','teacher'),('030001','tom','123456','student'),('030002','lucy','456789','student');
